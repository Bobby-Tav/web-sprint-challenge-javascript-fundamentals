...
// function animalNames(animalArray){
//   let nameArray = [];
//   animalArray.forEach(item => nameArray.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`))
//   return nameArray;
// }

// function lowerCaseNames(animalArray){ 
//   const newArray = animalArray.map(item => item.animal_name.toLowerCase());
//   return newArray;
// }

// function lowPopulationAnimals(animalArray){
//   const lowPop = animalArray.filter(item => item.population <5);
//   return lowPop;
// }

// function USApop(animalArray){
//   const totalPop = animalArray.reduce((acc,item) =>{
//     return acc + item.population;
//   },0);
//   return totalPop;
// }
